    ...
    def __init__(
        ...
        self.schema = pl.DataFrame(
            ...
            schema={
                ...
                "STD_OPENING_BALANCE": pl.Decimal(16, 4),
                "STD_TRANSACTION_PAYMENTS_IN": pl.Decimal(16, 4),
                "STD_TRANSACTION_PAYMENTS_OUT": pl.Decimal(16, 4),
                "STD_CLOSING_BALANCE": pl.Decimal(16, 4),
            },
        )
...
def _build_checks_and_balances_data(
    ...
    data = checks_and_balances.select(
        ...
        STD_MOVEMENT_HEADS="STD_MOVEMENT",
        STD_CLOSING_BALANCE_HEADS="STD_CLOSING_BALANCE",
        STD_OPENING_BALANCE_LINES=pl.col("STD_RUNNING_BALANCE").sub(pl.col("STD_TRANSACTION_MOVEMENT")),
        STD_PAYMENTS_IN_LINES="STD_TRANSACTION_PAYMENTS_IN",
        STD_PAYMENTS_OUT_LINES="STD_TRANSACTION_PAYMENTS_OUT",
        STD_MOVEMENT_LINES="STD_TRANSACTION_MOVEMENT",
...
def _build_statement_lines_data(
    ...
    return lines_results.collect().select(
        ...
        STD_OPENING_BALANCE=pl.col("STD_RUNNING_BALANCE").sub(pl.col("STD_TRANSACTION_MOVEMENT")),
        STD_TRANSACTION_PAYMENTS_IN="STD_TRANSACTION_PAYMENTS_IN",
        STD_TRANSACTION_PAYMENTS_OUT="STD_TRANSACTION_PAYMENTS_OUT",
